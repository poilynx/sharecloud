...
final class BrowserController extends ControllerBase {
	...
	public function index() {
		...
		foreach($files as $file) {
			//if(defined($files_auther[$file
			$files_auther[$file->id] = User::find('_id',$file->uid)->username;
		}
		
		$folders_auther = array();
		$folders = $folder->folders;
		#var_dump($folders);
		foreach($folders as $f) {
			//if(defined($files_auther[$file
			$folders_auther[$f->id] = User::find('_id',$f->uid)->username;
		}
		...
		$smarty->assign('filesAuther',$files_auther);
		$smarty->assign('foldersAuther',$folders_auther);
